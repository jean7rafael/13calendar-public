...
/* ===========================================================
   ÚNICAS URLS PÚBLICAS INDEXÁVEIS

   A lista indexável reproduz exatamente o sitemap. O widget recebe
   HTML próprio para não herdar a página inicial antes da hidratação,
   mas continua fora do sitemap e protegido por noindex. Operações
   comunitárias e a rota de fallback permanecem somente client-side.
=========================================================== */

export const indexedPublicRoutes = ['/', '/learn', '/tools', '/moon', '/news', '/community', '/privacy'];
export const nonIndexedRenderedRoutes = ['/widget'];
...
export const getSsgPages = defineSsgGetPages(
  () => [...indexedPublicRoutes, ...nonIndexedRenderedRoutes].map((route) => ({ route })),
);
