...
/* ===========================================================
   ...
   A lista reproduz exatamente o sitemap. Widget, operações
   comunitárias e a rota de fallback continuam client-side e não
   recebem um arquivo indexável no build estático.
=========================================================== */
...
export const getSsgPages = defineSsgGetPages(
  () => indexedPublicRoutes.map((route) => ({ route })),
);
