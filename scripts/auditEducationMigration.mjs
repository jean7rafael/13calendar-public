...
assert.match(moonSource, /education\.converter\.fixedDate/);
assert.match(moonSource, /education\.converter\.gregorianDate/);
...
assert.match(layoutSource, /holidayCountryCoachmarkOpen/);
assert.match(layoutSource, /holidaySettings\.countryMenuHint/);
assert.match(layoutSource, /void showHolidayCountryCoachmark\(\)/);
assert.doesNotMatch(layoutSource, /holidayCountryDialogOpen/);
